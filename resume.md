...
### EXPERTISE
---
SQL, dbt, Git, Airflow, BI tooling 


### EXPERIENCE
---
### Analytics Engineer @ Just Eat Takeway.com (Food tech)
**Jun 2025 – Present:** Building the semantic layer in Looker to empower UK data users:
- Led a full Looker refacto from scratch using best-practice data modeling and architecture;
- Drove end-to-end data solutions enabling strategic self-service access to menu session visits and item-level data;
- Owned Airflow DAGs and CI/CD pipelines to ensure reliable data workflows. <p>
**Techs:** Looker, Git, Airflow, Tableau

### Analytics Engineer @ Pinnu Analytics (Data consultancy)
**Jan 2025 – May 2025:** Specialized in data transformation and modeling using SQL and dbt. Responsible for developing, testing, deploying, and documenting modular data models.
- Audited and cleaned Chargebee data, fixing duplicates for accurate non-deterministic calculations;
- Improved ARR accuracy by redefining retention, cancellations, and voided invoices;
- Enhanced product tracking to detect downgrades by generating M-1 to M product states. <p>
...
- Migration: Migrated models into dbt, improving maintainability, testability, documentation, and cost-efficiency. <p>
...
- Automation: Automated data processing, reducing manual effort and saving 8 hours of work per week for the sales team. <p>
